...
public class JwtProvider implements IJwtProvider{
    ...
    public JwtProvider(@Value("${authentication.jwt.public-key}") String jwtPublic,
                       @Value("${authentication.jwt.private-key}") String jwtPrivate) {
        ...
        try{
            ...
            PKCS8EncodedKeySpec privateKeySpec=new PKCS8EncodedKeySpec(decoder.decode(jwtPrivate.getBytes()));
            X509EncodedKeySpec publicKeySpec= new X509EncodedKeySpec(decoder.decode(jwtPublic.getBytes()));
